...
namespace Api
{
    public class Startup
    {
            ...
            services.AddSwaggerGen(c =>
           {
               ...
               c.SwaggerDoc("v1",
                   new OpenApiInfo
                   {
                       ...
                       Version = "v1",
                       Description = "Serviço criado para processos do Gradeamento"
                   });
           });

            services.AddScoped<IGradeamentoRepository, GradeamentoRepository>();

            services.AddDbContext<GradeamentoContext>(options =>
           {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Serviço de Gradeamento");
            });
        }
    }
}
